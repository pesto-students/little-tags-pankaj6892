        ...
        <div className="main center">
          ...
          <div className="row">
            <div className="col-sm-6 p-85 left-aling">
              ...
              <p className="pt-65"><strong>ATTIRE FUSION</strong> is your unique clothing store for "Stylish & Trendy" cloghte online. Shop from the most exclusive collection.</p>

              <div className="button"><span>Shop Now </span></div>
            </div>
            <div className="col-sm-6 mt-0">
              <img src={pinkDress} alt="pink dress" width="470px"/>
            </div>
